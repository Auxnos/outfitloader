coroutine.resume(coroutine.create(function()
    ReplicatedStorage= game:GetService("ReplicatedStorage")
		...
		warn(ChatEvents,OnNewMessage)
        if OnNewMessage:IsA("RemoteEvent") then
            warn(OnNewMessage)
            OnNewMessage.OnClientEvent:Connect(function(data)
                warn(data)
                if data ~= nil then
...
Chat = function(v)
    warn(v)
	if string.match(string.lower(v), "wwwwassddddddddd") then
